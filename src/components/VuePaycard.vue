...
export default {
  ...
  computed: {
    ...
    getCreditCardImage() {
      const path = `../paycardAssets/images/${this.cardType}.png`;
      const modules = import.meta.globEager("../paycardAssets/images/*.png");
    ...
    currentCardBackground() {
      ...
      if (this.isBackgroundImageFromAssets) {
        const path = `../paycardAssets/images/${numberImage}.jpg`;
        const modules = import.meta.globEager("../paycardAssets/images/*.jpg");
        return modules[path].default;
      }
      ...
      if (this.hasRandomBackgrounds) {
        ...
        const path = `../paycardAssets/images/${random}.jpg`;
        const modules = import.meta.globEager("../paycardAssets/images/*.jpg");
        return modules[path].default;
      }
...
<style src="../paycardAssets/css/style.min.css" scoped></style>
